...
RSpec.describe "/customers", type: :request do
  ...
  it "index get/customers json" do
    get "/customers.json"
    expect(response.body).to include_json([ #remeber array
      id: /\d/, # A regesx matcher
      name: (be_kind_of String), #remeber db of teste and development are diferent. Why is more interesting to use rspec matchers. Like im doing
      email: (be_kind_of String)
    ])
  end

  it "show get/customers json" do
    get "/customers/1.json"
    expect(response.body).to include_json( #without array
      id: 1,
