...
VCR.configure do |config|
  ...
  config.configure_rspec_metadata! # It makes possible to replace tjis line: VCR.use_cassette("jsonplaceholder/post") do ---- when coding the test
...
# # 4 step for capybara screenshot - chrome headless
